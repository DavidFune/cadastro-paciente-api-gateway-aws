...
const dynamoDb = isOffline()
  ? new AWS.DynamoDB.DocumentClient(dynamodbOffileOptions)
...
module.exports.cadastrarPaciente = async (event) => {
  ...
  try {
    ...
    const {
      nome, data_nacimento, email, telefone
    } = dados;
...
module.exports.atualizarPaciente = async (event) => {  
  ...
  try {
    ...
    let error = e.name ? e.name : "Exception";
    let message = e.message ? e.message : "Unknown error";
